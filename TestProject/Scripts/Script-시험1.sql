...
ALTER TABLE DEPARTMENTS2 ADD CONSTRAINT PK_DEPARTMENTS PRIMARY KEY(DEPTNO);
ALTER TABLE DEPARTMENTS2 ADD CONSTRAINT FK_DEPARTMENTS_PROFESSOR FOREIGN KEY(PROFNO) REFERENCES PROFESSOR(PROFNO);
INSERT INTO DEPARTMENTS2 VALUES(101, '컴퓨터공학과', 9901, '1호관');
INSERT INTO DEPARTMENTS2 VALUES(102, '멀티미디어학과', 9902, '2호관');
INSERT INTO DEPARTMENTS2 VALUES(201, '전자공학과', 9903, '3호관');
INSERT INTO DEPARTMENTS2 VALUES(202, '기계공학과', 9904, '4호관');
INSERT INTO DEPARTMENTS2 VALUES(100, '정보미디어학과', 9905, '5호관');
INSERT INTO DEPARTMENTS2 VALUES(200, '메카트로닉스학과', 9906, '6호관');
INSERT INTO DEPARTMENTS2 VALUES(300, '빅데이터학과', 9907, '7호관');
INSERT INTO DEPARTMENTS2 VALUES(400, '응용소프트웨어학과', 9908, '8호관');
COMMIT;
-- 학생 테이블
...
ALTER TABLE STUDENT ADD CONSTRAINT FK_STUDENT_DEPARTMENTS2 FOREIGN KEY(DEPTNO) REFERENCES DEPARTMENTS2(DEPTNO);
...
생일(BIRTHDATE) 칼럼 데이터를 'YYYY-MM-DD' 형식으로 조회하는 쿼리문을 작성하시오. (10점)
*/
-- 날짜를 만드는 함수        : TO_DATE
-- 날짜 형식을 변경하는 함수 : TO_CHAR
SELECT TO_CHAR(BIRTHDATE, 'YYYY-MM-DD') AS "생 일" FROM STUDENT;

/*
2.
교수(PROFESSOR) 테이블의 고용일(HIREDATE) 칼럼을 이용하여 현재까지 근무한 일수를 조회하는 쿼리문을 작성하시오.
결과는 정수로 내림 또는 절사(소수점 잘라 버리기)하여 표시하시오.(컬럼제목 '근무일'로 변경 (10점)
*/
...
/*
3.
학생(STUDENT) 테이블의 키(HEIGHT) 칼럼의 데이터 중에서 가장 높은 키를 조회하는 쿼리문을 작성하시오.(컬럼제목 '최대키'로 변경) (10점)
*/
SELECT MAX(HEIGHT) AS 최대키 FROM STUDENT;

/*
4.
학생(STUDENT) 테이블에 있는 전체 학생수를 조회하는 쿼리문을 작성하시오.(컬럼제목을 '학생수'로 변경하시오) (10점)
*/
SELECT COUNT(*) 학생수 
	FROM STUDENT ;
/*
...
*/
SELECT S.SNAME 학생명, D.DNAME 학과명, P.PNAME 담당교수명
	FROM STUDENT S JOIN DEPARTMENTS2 D 
	ON S.DEPTNO = D.DEPTNO JOIN PROFESSOR P
	ON D.PROFNO = P.PROFNO
	GROUP BY S.SNAME, D.DNAME, P.PNAME;
/*
8.
모든 학과의 학과별 학생수를 조회하시오. 소속 학생이 없으면 0으로 조회하시오. (10점)
*/
SELECT D.DNAME 학과명, COUNT(*) 학생수 
	FROM STUDENT S LEFT OUTER JOIN DEPARTMENTS2 D
...
*/		  
SELECT ROUND(AVG(HEIGHT),1) 평균키 FROM STUDENT s GROUP BY GRADE;	
SELECT ROUND(AVG(WEIGHT),1) 평균몸무게 FROM STUDENT s GROUP BY GRADE;
